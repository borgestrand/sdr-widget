...
/// Represents a single 8-bit register on the SDR-1000 RFE board
class RFEReg : public HwReg
{
...
public:
	/// Basic constructor
	RFEReg(char* name, SDR1000* sdr, uint8 addr);
	/// Constructor with initial value
	RFEReg(char* name, SDR1000* sdr, uint8 addr, uint8 init_val);
};
