...
#define EP_REFRESH_5_FS		0x01 // was: 0x05			 //  64ms, BSB 20130603: 0x05 measured as 32ms, 0x02 measured as 2ms
#define EP_REFRESH_5_HS		0x01 // was: 0x05			 // 2^(10-1) = 512 uframe = 64ms
