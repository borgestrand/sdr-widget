...
*/
	#define ADC_BUFFER_SIZE	390 // (8*2*24) * 1 // = 384 = 192 stereo samples ADC_site requires uncomfortably much fine-tuning in order to work with two consumers
	#define DAC_BUFFER_SIZE 1560 // (32*2*24) * 1 // = 1536
