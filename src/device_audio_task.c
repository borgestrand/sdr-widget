...
volatile uint8_t wm8804_LINK_MAX_ATTEMPTS = 0x29;	// 29 Results after 1st optimization - increase all three to lower risk of noise at cost of longer scan times 
volatile uint8_t wm8804_LINK_DETECTS_OK = 0x05;		// 05 Results after 1st optimization 
volatile uint8_t wm8804_TRANS_ERR_FAILURE = 0x14;	// 14 Results after 1st optimization
