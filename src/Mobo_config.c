...
*/
	...
	// Does spdif timer interrupt indicate that we should process 250-ish 탎 of incoming SPDIF data?
...
void mobo_start_spdif_tc(U32 frequency) {
	...
	switch (frequency) {
		case FREQ_44:
			temp = 11;	// UAC2: 11.025 samples per 250탎
		break;
		case FREQ_48:
			temp = 12;	// UAC2: 12 samples per 250탎
		break;
		case FREQ_88:
			temp = 22;	// UAC2: 22.05 samples per 250탎
		break;
		case FREQ_96:
			temp = 24;	// UAC2: 24 samples per 250탎
		break;
		case FREQ_176:
			temp = 44;	// UAC2: 44.1 samples per 250탎
		break;
		case FREQ_192:
