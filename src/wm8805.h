...
#define WM8805_PAUSE_LIM	400	// 200			// Poll cycles to determine that a previously playing input is silent. NB: Signed 16-bit number!
#define WM8805_SILENCE_LIM	40					// Poll cycles to wait for a mute input to produce audio
